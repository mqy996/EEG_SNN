...
manifest to the curated artifact directory when `HLS6D_DIAG_ARTIFACT_DIR` is
provided.

## Board order

Program the existing HLS-6B bitstream, download the generated diagnostic ELF,
and capture COM5 at 115200 8-N-1. Stop at the first missing marker. Do not run
full replay or ILA as part of HLS-6D.
