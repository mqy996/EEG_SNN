# Copied from the official Digilent PYNQ-Z2 v1.0 master XDC package on 2026-07-26.
# It is kept as a board-reference file; only uncomment ports that exist in the final top.
