# AX7020 minimal GPIO system using a generated PS7 configuration script
...
file mkdir $work_dir
create_project -force a7g $project_dir -part $part
...
set axi_defs [get_ipdefs -all xilinx.com:ip:axi_interconnect:2.1]
if {[llength $axi_defs] == 0} { error "xilinx.com:ip:axi_interconnect:2.1 is unavailable" }
...
connect_bd_net [get_bd_pins $ps/FCLK_CLK0] [get_bd_pins $axi/ACLK] [get_bd_pins $axi/S00_ACLK] [get_bd_pins $axi/M00_ACLK] [get_bd_pins $gpio/s_axi_aclk] [get_bd_pins $rst/slowest_sync_clk]
connect_bd_net [get_bd_pins $ps/FCLK_RESET0_N] [get_bd_pins $rst/ext_reset_in]
connect_bd_net [get_bd_pins $rst/peripheral_aresetn] [get_bd_pins $axi/ARESETN] [get_bd_pins $axi/S00_ARESETN] [get_bd_pins $axi/M00_ARESETN] [get_bd_pins $gpio/s_axi_aresetn]
assign_bd_address
...
report_property [get_bd_cells $axi] > [file join $work_dir axi_interconnect_properties.rpt]
