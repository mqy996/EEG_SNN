...
set out_prefix mt41k_smartconnect_gpio_minimal
set bd_name ax7020_ps7_base
set project_dir [file join $work_dir project]
file mkdir $work_dir
create_project -force mt41k_smartconnect_gpio $project_dir -part $part
...
source [file join $repo vivado experimental mt41k_gpio_minimal template_ps7_ax7020_mt41k.tcl]
